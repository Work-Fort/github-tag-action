...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const latestTag = yield (0, utils_1.getLatestTag)(validTags, prefixRegex, tagPrefix);
        const latestPrereleaseTag = (0, utils_1.getLatestPrereleaseTag)(validTags, identifier, prefixRegex);
        let commits;
        let newVersion;
        if (customTag) {
            commits = yield (0, utils_1.getCommits)(latestTag.commit.sha, commitRef, paths);
            ...
            commits = yield (0, utils_1.getCommits)(previousTag.commit.sha, commitRef, paths);
