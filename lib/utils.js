...
function getCommits(baseRef, headRef, paths) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (paths && paths.length > 0) {
            const pathScopedShas = yield getPathScopedCommitShas(baseRef, headRef, paths);
            core.debug(`Path filter matched ${pathScopedShas.size} of ${filteredCommits.length} commits.`);
            filteredCommits = filteredCommits.filter((commit) => pathScopedShas.has(commit.sha));
        }
 ...
 */
function getPathScopedCommitShas(baseRef, headRef, paths) {
    return __awaiter(this, void 0, void 0, function* () {
        const args = [
            'log',
            '--format=%H',
        ...
        const { stdout } = yield (0, exec_1.getExecOutput)('git', args);
        const shas = new Set(stdout
            .trim()
            .split('\n')
...
function getLatestTag(tags, prefixRegex, tagPrefix) {
    return __awaiter(this, void 0, void 0, function* () {
        const found = tags.find((tag) => prefixRegex.test(tag.name) &&
